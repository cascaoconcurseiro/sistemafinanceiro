...
const FinancialAutomationManager: React.FC<AutomationManagerProps> = ({
  ...
  const loadData = async () => {
    try {
      ...
      logError.ui('Erro ao carregar dados de automação:', error);
  ...
  const handleCreateRecurring = async () => {
    try {
      ...
      logError.ui('Erro ao salvar transação recorrente:', error);
  ...
  const handleCreateAlert = async () => {
    try {
      ...
      logError.ui('Erro ao salvar alerta:', error);
  ...
  const handleCreateBudgetRule = async () => {
    try {
      ...
      logError.ui('Erro ao salvar regra de orçamento:', error);
