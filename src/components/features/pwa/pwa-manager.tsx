...
// import { pushNotificationService } from '@/lib/push-notification-service'; // Removido
...
export function PWAManager({ onInstallPrompt }: PWAManagerProps) {
  ...
  useEffect(() => {
    ...
    // Service Worker update detection (registration handled by push notification service)
    if (
      ...
      // Wait for Service Worker to be ready and then listen for updates
