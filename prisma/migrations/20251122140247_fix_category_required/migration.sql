...
INSERT INTO "new_transactions" ("account_id", "amount", "budget_id", "category_id", "closed_period", "created_at", "created_by", "credit_card_id", "currency", "date", "deleted_at", "description", "exchange_rate", "frequency", "goal_id", "id", "installment_group_id", "installment_number", "investment_id", "invoice_id", "is_fraudulent", "is_installment", "is_reconciled", "is_recurring", "is_shared", "is_suspicious", "is_tax_deductible", "is_transfer", "metadata", "my_share", "operation_uuid", "original_amount", "owed_to", "paid_by", "parent_transaction_id", "payment_method", "reconciled_at", "recurring_id", "shared_with", "status", "tax_category", "total_installments", "total_shared_amount", "transaction_group_id", "transfer_id", "transfer_type", "trip_expense_type", "trip_id", "type", "updated_at", "updated_by", "user_id", "version") SELECT "account_id", "amount", "budget_id", "category_id", "closed_period", "created_at", "created_by", "credit_card_id", "currency", "date", "deleted_at", "description", "exchange_rate", "frequency", "goal_id", "id", "installment_group_id", "installment_number", "investment_id", "invoice_id", "is_fraudulent", "is_installment", "is_reconciled", "is_recurring", "is_shared", "is_suspicious", "is_tax_deductible", "is_transfer", "metadata", "my_share", "operation_uuid", "original_amount", "owed_to", "paid_by", "parent_transaction_id", "payment_method", "reconciled_at", "recurring_id", "shared_with", "status", "tax_category", "total_installments", "total_shared_amount", "transaction_group_id", "transfer_id", "transfer_type", "trip_expense_type", "trip_id", "type", "updated_at", "updated_by", "user_id", "version" FROM "transactions";
DROP TABLE "transactions";
ALTER TABLE "new_transactions" RENAME TO "transactions";
CREATE UNIQUE INDEX "transactions_operation_uuid_key" ON "transactions"("operation_uuid");
...
CREATE INDEX "transactions_operation_uuid_idx" ON "transactions"("operation_uuid");
